...
const experiences = [
  ...
  },
  {
    ...
    organization: "Cisco Systems — Cisco Spaces Division",
...
export function ExperienceSection() {
  return (
    <section id="experience" className="py-24 md:py-32 bg-secondary/30 border-y">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        <FadeIn>
          <div className="text-center mb-16">
            <h2 className="text-sm font-semibold tracking-widest text-primary uppercase mb-3">04. Journey</h2>
            <h3 className="text-3xl md:text-4xl font-display font-bold">Experience & Education</h3>
          </div>
        </FadeIn>
